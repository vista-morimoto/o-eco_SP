...
$(function() {
 ...
 if(isIE){
   var url="http://gdata.youtube.com/feeds/api/playlists/PLS5jn8RBBk44b0u1fDf7agICHizNPG2GC?alt=json-in-script&callback=getList";
   ...
   document.getElementsByTagName("head")[0].appendChild(script);
	...
	$.getJSON(
		//学校のYoutubeユーザーを指定
		"http://gdata.youtube.com/feeds/api/playlists/PLS5jn8RBBk454JLW4aw9Ct3sYnxT1vKiu?alt=json", /* 日本 */
		{
		   v:2,
		   alt:"json"
		},
