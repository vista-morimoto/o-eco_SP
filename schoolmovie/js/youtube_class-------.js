...
$(function() {
 ...
 if(isIE){
   var url="http://gdata.youtube.com/feeds/api/playlists/PLRl1aQqhyuwxje836vE6gk-2E-RZtUy2i?alt=json-in-script&callback=getList";
   ...
   document.getElementsByTagName("head")[0].appendChild(script);
	...
	$.getJSON(
		//学校のYoutubeユーザーを指定
		"http://gdata.youtube.com/feeds/api/playlists/PLRl1aQqhyuwxje836vE6gk-2E-RZtUy2i?alt=json", /* 日本 */
		{
		   v:2,
		   alt:"json"
		},
